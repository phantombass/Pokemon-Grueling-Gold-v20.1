...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/d/a/mkxp-z/mkxp-z/windows/build-mingw64' '--prefix=D:/a/mkxp-z/mkxp-z/windows/build-mingw64' '--enable-install-static-library' '--disable-install-doc' '--without-ext=readline,dbm,gdbm,win32ole' '--with-static-linked-ext' '--disable-rubygems' '--without-gmp' 'CC=gcc' 'CFLAGS=-flto -I/d/a/mkxp-z/mkxp-z/windows/build-mingw64/include -O3' 'LDFLAGS=-flto -L/d/a/mkxp-z/mkxp-z/windows/build-mingw64/lib'"
  ...
  CONFIG["DLDFLAGS"] = "-flto -L/d/a/mkxp-z/mkxp-z/windows/build-mingw64/lib -Wl,--enable-auto-image-base,--enable-auto-import"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc.exe (Rev3, Built by MSYS2 project) 14.1.0\nCopyright (C) 2024 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "D:/a/_temp/msys64/mingw64/bin/gcc.exe"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["LDFLAGS"] = "-L. -flto -L/d/a/mkxp-z/mkxp-z/windows/build-mingw64/lib -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = "-flto -I/d/a/mkxp-z/mkxp-z/windows/build-mingw64/include -O3"
